...
<body>
<?php	
	function getTotalData($data_increase_per_day, $num_days_in_month) { // 반복되는 작업을 함수로 만들자!
		$data_total = 0;
		$data_per_day = 100;
