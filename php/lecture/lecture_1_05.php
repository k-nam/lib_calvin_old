...
<?php
	$cost_total;
	$man_ratio_for_dating_cost; // 이 변수는 어떤 의미가 있는가? 필요한가?
	$woman_ratio_for_dating_cost;
	$man_share_for_cost_dinner;
	$man_share_for_cost_movie;
	$man_share_for_cost_coffee;
	$man_share_for_cost_total; // 다시계산 (반복)
?>
...
<?php
	$man_share_for_cost_dinner;
?>
그러자 여자가 말하길, "헐, 나 오빠 진짜 그렇게 안봤는데... 나도 솔직히 할 말 많거든? 아까 파스타집에서 같이 먹자고 시킨 까르보나라 솔직히 오빠가 다 먹었잔아? 나도 점심 못 먹어서 배고픈데 오빠 생각해서 참은거거든? 오빠가 먹은 걸 생각해봐 좀. 25000원 중에 15000원도 넘겠다, 진짜. 그럼 오빠 식으로 계산하면 오빠가 밥값 15000원이랑 나머지에서 반땡한거 <?php echo $man_share_for_cost_movie + $man_share_for_cost_coffee; ?>원 내야되니까 35000원 딱이네? 안그래?" <br><br>

<?php
	$man_share_for_cost_popcorn;
	$man_share_for_cost_movie;
	$man_share_for_cost_total; // 다시계산 (반복)
?>
