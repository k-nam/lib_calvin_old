...
public class TestSet extends Fragment implements OnClickListener {
	static MainTab mainTabActivity;
	static CharSequence[] dialogItems = { "Apple", "Samsung", "LG" };
	static boolean[] dialogItemsCheckingStatus = new boolean[dialogItems.length];
	...
	public static class MySimpleDialog extends DialogFragment {
	...
	public static class MyComplexProgressDialog extends DialogFragment {
